...
project = 'BrainScaleS-1 Demos & Examples'
copyright = '2024, Electronic Vision(s), Kirchhoff-Institute for Physics, ' \
...
man_pages = [
    (master_doc, 'brainscales1-demos', 'BrainScaleS-1 Demos',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinxcontrib-jupyterminimal', 'BrainScaleS-1 Demos',
     author, 'brainscales1-demos', 'Demos and tutorials for BrainScaleS-1',
     'Miscellaneous'),
]
